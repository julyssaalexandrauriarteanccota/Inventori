...
export class ConfiguracionFiscalService {
  ...
  async upsertConfigFiscal(dto: UpdateConfigEmpresaFiscalDto) {
    ...
    const data = {
      ...
      departamentoFiscal: this.optional(dto.departamentoFiscal),
      provinciaFiscal: this.optional(dto.provinciaFiscal),
      distritoFiscal: this.optional(dto.distritoFiscal),
