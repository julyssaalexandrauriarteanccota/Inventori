...
<Invoice xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#">
  ...
  console.log('Has encoding="ISO-8859-1":', signed.includes('encoding="ISO-8859-1"'));
  ...
  const withoutSig = signed.replace(/<ds:Signature[\s\S]*?<\/ds:Signature>/, '');
  const origWithoutExt = xml.replace(/<ext:ExtensionContent><\/ext:ExtensionContent>/, '<ext:ExtensionContent></ext:ExtensionContent>');
  console.log('\nStructure changed (beyond signature):', withoutSig !== origWithoutExt);
