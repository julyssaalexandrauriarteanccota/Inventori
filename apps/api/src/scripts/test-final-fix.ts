/**
 * FINAL FIX TEST: Nubefact-style XML with ALL proper attributes,
 * no languageLocaleID on Note, correct filename matching.
 */
...
async function main() {
  ...
  // Nubefact-style complete XML with correct filename
  const NUM = 'BBB1-50';
  const FN = `${RUC}-03-BBB1-50.xml`;
...
<Invoice xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ccts="urn:un:unece:uncefact:documentation:2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:qdt="urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2" xmlns:udt="urn:un:unece:uncefact:data:specification:UnqualifiedDataTypesSchemaModule:2" xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2">
  ...
  <cac:Signature>
    ...
    <cac:SignatoryParty>
      ...
      <cac:PartyName><cbc:Name>APAZA GONZALES CIRO ABEL</cbc:Name></cac:PartyName>
    </cac:SignatoryParty>
    <cac:DigitalSignatureAttachment>
      <cac:ExternalReference><cbc:URI>${RUC}</cbc:URI></cac:ExternalReference>
    </cac:DigitalSignatureAttachment>
  </cac:Signature>
  <cac:AccountingSupplierParty>
    <cac:Party>
      ...
      <cac:PartyLegalEntity>
        <cbc:RegistrationName>APAZA GONZALES CIRO ABEL</cbc:RegistrationName>
  ...
  <cac:AccountingCustomerParty>
    <cac:Party>
      <cac:PartyIdentification>
        <cbc:ID schemeID="6" schemeName="Documento de Identidad" schemeAgencyName="PE:SUNAT" schemeURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo06">20131312955</cbc:ID>
      </cac:PartyIdentification>
      <cac:PartyLegalEntity>
        <cbc:RegistrationName>SUPERINTENDENCIA NACIONAL DE ADUANAS Y DE ADMINISTRACION TRIBUTARIA - SUNAT</cbc:RegistrationName>
        <cac:RegistrationAddress>
          <cac:AddressLine><cbc:Line>LIMA</cbc:Line></cac:AddressLine>
        </cac:RegistrationAddress>
      </cac:PartyLegalEntity>
    </cac:Party>
  </cac:AccountingCustomerParty>
  ...
  <cac:InvoiceLine>
    ...
    <cac:PricingReference>
      <cac:AlternativeConditionPrice>
        <cbc:PriceAmount currencyID="PEN">118.0</cbc:PriceAmount>
    ...
    <cac:Item>
      <cbc:Description>DESCRIPCION DEL PRODUCTO</cbc:Description>
      <cac:SellersItemIdentification><cbc:ID>1001</cbc:ID></cac:SellersItemIdentification>
    </cac:Item>
    <cac:Price>
  ...
  const signed = sign(xmlFull, pk, cert);
  console.log(`Signed XML length: ${signed.length}`);
  console.log(`Has ds:Signature: ${signed.includes('<ds:Signature')}`);
  await send('FULL Nubefact-style (signed by us)', signed, FN);
