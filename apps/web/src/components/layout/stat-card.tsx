...
> = {
  sky: {
    card: "bg-sky-100/80 dark:bg-sky-500/10 border-sky-300/80 dark:border-sky-500/30",
    tile: "bg-sky-500 text-white shadow-sm shadow-sky-500/30 dark:bg-sky-600 dark:text-sky-50 dark:shadow-none",
    text: "text-white",
    watermark: "text-sky-500 dark:text-sky-400/60",
  },
  indigo: {
    card: "bg-indigo-100/80 dark:bg-indigo-500/10 border-indigo-300/80 dark:border-indigo-500/30",
    tile: "bg-indigo-500 text-white shadow-sm shadow-indigo-500/30 dark:bg-indigo-600 dark:text-indigo-50 dark:shadow-none",
    text: "text-white",
    watermark: "text-indigo-500 dark:text-indigo-400/60",
  },
  violet: {
    card: "bg-violet-100/80 dark:bg-violet-500/10 border-violet-300/80 dark:border-violet-500/30",
    tile: "bg-violet-500 text-white shadow-sm shadow-violet-500/30 dark:bg-violet-600 dark:text-violet-50 dark:shadow-none",
    text: "text-white",
    watermark: "text-violet-500 dark:text-violet-400/60",
  },
  amber: {
    card: "bg-amber-100/80 dark:bg-amber-500/10 border-amber-300/80 dark:border-amber-500/30",
    tile: "bg-amber-500 text-white shadow-sm shadow-amber-500/30 dark:bg-amber-600 dark:text-amber-50 dark:shadow-none",
    text: "text-white",
    watermark: "text-amber-500 dark:text-amber-400/60",
  },
  emerald: {
    card: "bg-emerald-100/80 dark:bg-emerald-500/10 border-emerald-300/80 dark:border-emerald-500/30",
    tile: "bg-emerald-500 text-white shadow-sm shadow-emerald-500/30 dark:bg-emerald-600 dark:text-emerald-50 dark:shadow-none",
    text: "text-white",
    watermark: "text-emerald-500 dark:text-emerald-400/60",
  },
  red: {
    card: "bg-red-100/80 dark:bg-red-500/10 border-red-300/80 dark:border-red-500/30",
    tile: "bg-red-500 text-white shadow-sm shadow-red-500/30 dark:bg-red-600 dark:text-red-50 dark:shadow-none",
    text: "text-white",
    watermark: "text-red-500 dark:text-red-400/60",
  },
  rose: {
    card: "bg-rose-100/80 dark:bg-rose-500/10 border-rose-300/80 dark:border-rose-500/30",
    tile: "bg-rose-500 text-white shadow-sm shadow-rose-500/30 dark:bg-rose-600 dark:text-rose-50 dark:shadow-none",
    text: "text-white",
    watermark: "text-rose-500 dark:text-rose-400/60",
  },
  slate: {
    card: "bg-slate-200/70 dark:bg-slate-700/30 border-slate-300/80 dark:border-slate-600/60",
