// Espejo del helper en `apps/api/src/modules/facturacion/numero-a-letras.ts`.
// Genera el monto en letras para la representación impresa SUNAT
// (boleta/factura electrónica). Formato: "DOSCIENTOS TREINTA Y SEIS Y 00/100 SOLES".
